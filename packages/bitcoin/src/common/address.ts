...
export const validateBitcoinAddress = (
  ...
  try {
    ...
    if (
      decodedBase58.version === bitcoinNetwork.pubKeyHash ||
      decodedBase58.version === bitcoinNetwork.scriptHash
    ) {
 ...
 */
export const isP2trAddress = (address: string): boolean =>
