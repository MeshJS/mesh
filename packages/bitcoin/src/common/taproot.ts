import { BN, ecc, sha256 } from "../core";

/**
 * The secp256k1 order n:
 * FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141
 */
const SECP256K1_ORDER = new BN(
  "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141",
  16
);
 ...
 */
export const tweakTaprootPubKey = (
  ...
  const result = ecc.xOnlyPointAddTweak(
    new Uint8Array(internalPubKey),
    new Uint8Array(tweak)
  );
  if (result === null) {
 ...
 */
export const tweakTaprootPrivateKey = (
  derivedPrivateKey: Buffer,
  internalPubKey: Buffer
): Buffer => {
