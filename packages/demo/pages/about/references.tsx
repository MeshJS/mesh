    ...
    <>
      <blockquote className="twitter-tweet">
        <p lang="en" dir="ltr">
          ...
          <a href="https://twitter.com/hashtag/Cardano?src=hash&amp;ref_src=twsrc%5Etfw">
            #Cardano
          </a>{' '}
          so easily with{' '}
          <a href="https://twitter.com/meshsdk?ref_src=twsrc%5Etfw">@meshsdk</a>
          . Same old React stuff with NextJS. Host on{' '}
          <a href="https://twitter.com/vercel?ref_src=twsrc%5Etfw">@vercel</a>{' '}
          in 5 mins. Download{' '}
          <a href="https://twitter.com/FlintWallet?ref_src=twsrc%5Etfw">
            @FlintWallet
          </a>{' '}
          and access through dApp browser. Boom, you&#39;re live. And
          multi-platform. And iterating. 100x speed.{' '}
          <a href="https://twitter.com/MochaApp?ref_src=twsrc%5Etfw">
            @MochaApp
          </a>{' '}
          WIP. <a href="https://t.co/k7NKUWf2ts">pic.twitter.com/k7NKUWf2ts</a>
        </p>
        &mdash; Jeremy Soo (@Jeremysoojk){' '}
        <a href="https://twitter.com/Jeremysoojk/status/1626857977675411458?ref_src=twsrc%5Etfw">
          February 18, 2023
        </a>
      </blockquote>
      <blockquote className="twitter-tweet">
        <p lang="en" dir="ltr">
          ...
          <a href="https://twitter.com/meshsdk?ref_src=twsrc%5Etfw">
            @meshsdk
          </a>{' '}
          check out my idiot-proof guide
          <a href="https://t.co/TWnHldEhDn">https://t.co/TWnHldEhDn</a>
        </p>
        &mdash; BlockSplained (@blocksplained){' '}
        <a href="https://twitter.com/blocksplained/status/1625831013724168192?ref_src=twsrc%5Etfw">
          February 15, 2023
        </a>
      </blockquote>
      <blockquote className="twitter-tweet" data-conversation="none">
        <p lang="en" dir="ltr">
          ...
          <a href="https://twitter.com/meshsdk?ref_src=twsrc%5Etfw">@meshsdk</a>{' '}
          and{' '}
          <a href="https://twitter.com/jinglescode?ref_src=twsrc%5Etfw">
            @jinglescode
          </a>{' '}
          ...
          code much easier 💪
          <a href="https://t.co/qZiRqepAjw">https://t.co/qZiRqepAjw</a>
        </p>
        &mdash; Mladen Lm | Cardano Rumors Guy (@MladenLm){' '}
        <a href="https://twitter.com/MladenLm/status/1625986026463236096?ref_src=twsrc%5Etfw">
          February 15, 2023
        </a>
      </blockquote>
      <blockquote className="twitter-tweet">
        <p lang="en" dir="ltr">
          ...
          <br />
          Article by{' '}
          <a href="https://twitter.com/blocksplained?ref_src=twsrc%5Etfw">
            @blocksplained
          </a>{' '}
          <a href="https://twitter.com/hashtag/Cardano?src=hash&amp;ref_src=twsrc%5Etfw">
            #Cardano
          </a>{' '}
          <a href="https://twitter.com/search?q=%24ADA&amp;src=ctag&amp;ref_src=twsrc%5Etfw">
            $ADA
          </a>
          <a href="https://t.co/7WErQ046Rd">https://t.co/7WErQ046Rd</a>
        </p>
        &mdash; Ada Pulse (@Adapulse_io){' '}
        <a href="https://twitter.com/Adapulse_io/status/1625489873879826432?ref_src=twsrc%5Etfw">
          February 14, 2023
        </a>
      </blockquote>
      <blockquote className="twitter-tweet" data-conversation="none">
        ...
        <a href="https://twitter.com/jackfriks/status/1623356244969902085?ref_src=twsrc%5Etfw">
          February 8, 2023
        </a>
      </blockquote>
      <blockquote className="twitter-tweet" data-conversation="none">
        ...
        &mdash; jack friks (@jackfriks){' '}
        <a href="https://twitter.com/jackfriks/status/1623351158809976832?ref_src=twsrc%5Etfw">
          February 8, 2023
        </a>
      </blockquote>
      <blockquote className="twitter-tweet" data-conversation="none">
        <p lang="en" dir="ltr">
          ...
          at{' '}
          <a href="https://twitter.com/hashtag/CardanoSummit2022?src=hash&amp;ref_src=twsrc%5Etfw">
            #CardanoSummit2022
          </a>{' '}
          SG event and was blown away. You&#39;ve got to check out{' '}
          <a href="https://t.co/Tj7bnVSUyg">https://t.co/Tj7bnVSUyg</a>.<br />
          <br />
          🚨 Builders take note!{' '}
          <a href="https://t.co/FOu7vDDnnu">https://t.co/FOu7vDDnnu</a>
        </p>
        &mdash; Jeremy Soo (@Jeremysoojk){' '}
        <a href="https://twitter.com/Jeremysoojk/status/1620068978432561155?ref_src=twsrc%5Etfw">
          January 30, 2023
        </a>
      </blockquote>
      <blockquote className="twitter-tweet" data-conversation="none">
        <p lang="en" dir="ltr">
          ...
          <a href="https://twitter.com/ChainChillaz?ref_src=twsrc%5Etfw">
            @ChainChillaz
          </a>{' '}
          next month.
        </p>
        &mdash; haz (@HazRyder){' '}
        <a href="https://twitter.com/HazRyder/status/1617241575171710976?ref_src=twsrc%5Etfw">
          January 22, 2023
        </a>
      </blockquote>
      <blockquote className="twitter-tweet" data-conversation="none">
        <p lang="en" dir="ltr">
          ...
          at <a href="https://t.co/8IGL8h9U6J">https://t.co/8IGL8h9U6J</a>
          <br />
          <br />
          ...
          apps <a href="https://t.co/AADMZULPpR">https://t.co/AADMZULPpR</a>
        </p>
        &mdash; ADA whale (@cardano_whale){' '}
        <a href="https://twitter.com/cardano_whale/status/1611573829905846273?ref_src=twsrc%5Etfw">
          January 7, 2023
        </a>
      </blockquote>
    </>
