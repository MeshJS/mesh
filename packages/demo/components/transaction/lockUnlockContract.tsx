  ...
  async function makeTransactionLockAsset() {
    ...
    try {
      ...
      const datum = [
        ...
        'c8b7333b533eedce34c6cee1098aa3797d51cb19a4db50bf56be3243',
      ];
      ...
      const tx = new TransactionService({ initiator: wallet }).sendAssets(
        scriptAddress,
        assets,
        { datum: datum }
      );
  ...
  async function makeTransactionUnlockAsset() {
    ...
    try {
      ...
      if (assetUtxo) {
        ...
        const protocol = await blockfrost.fetchProtocolParameters();
        ...
        console.log(
          'RS',
          resolveAddressKeyHash(
            'addr_test1qrytwvem2vlwmn35cm8wzzv25duh65wtrxjdk59l26lrysuvldqg2n2p8y4kyjm8sqfyg0tpq9042atz0fr8c3grjmyscx0sxt'
          )
        );
