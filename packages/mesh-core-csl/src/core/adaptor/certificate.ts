...
export const baseCertToObj = (baseCert: CertificateType): object => {
  switch (baseCert.type) {
    ...
    case "RegisterStake":
      return {
        registerStake: {
          stakeKeyHash: baseCert.stakeKeyHash,
        },
      };
    case "DelegateStake":
      return {
    ...
    case "CommitteeHotAuth":
      return {
        committeeHotAuth: {
          committeeColdKeyHash: baseCert.committeeColdKeyHash,
          committeeHotKeyHash: baseCert.committeeHotKeyHash,
        },
      };
    ...
    case "DRepRegistration":
      return {
        dRepRegistration: {
          votingKeyHash: baseCert.votingKeyHash,
          coin: baseCert.coin,
          anchor: baseCert.anchor ?? null,
        },
      };
