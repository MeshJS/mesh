    ...
    <SidebarFullwidth sidebarItems={sidebarItems}>
      ...
      >
        <p>
          ...
          Plutus scripts in transactions without requiring network connectivity. It works
          with an {" "}
          <Link href="/providers/offline-fetcher">
            OfflineFetcher
          </Link>
          {" "} to resolve the UTXOs needed for script validation.
        </p>
        ...
        <p>
          The evaluator is particularly useful for testing Plutus scripts, ensuring
          they execute within memory and CPU limits:
        </p>
        <Codeblock data={code3} />

        <p>
          The evaluation results include memory units and CPU steps required for each
          script execution, helping you optimize your scripts and ensure they meet
