...
export const metadata = {
  ...
  cover: "/guides/smart-contract-transactions.png",
...
In this guide, we will build a marketplace where users can list their assets for sale and purchase the listed assets. The seller can update or cancel the listing at any time. The contract is written in Haskell, and it is open-source and available on [GitHub](https://github.com/MeshJS/mesh.plutus/tree/marketplace).
