...
export const metadata = {
  ...
  cover: "/guides/implement-custom-provider.png",
...
As of writing (Dec 2022), Mesh offers three options: [Blockfrost](https://blockfrost.io/), [Tangocrypto](https://tangocrypto.com/), or [Koios](https://www.koios.rest/) (see a list of [Providers](https://meshjs.dev/providers)) . These blockchain providers allow developers to access the Cardano blockchain and retrieve intricate data. For example, they can be used to query the UTXO of a smart contract and use it as part of a transaction, or to submit a signed transaction to the chain.
